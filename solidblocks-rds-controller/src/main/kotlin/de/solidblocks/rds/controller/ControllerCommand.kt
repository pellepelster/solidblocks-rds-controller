...
import de.solidblocks.rds.controller.api.provider.ProviderManager
import de.solidblocks.rds.controller.api.provider.ProvidersApi
...
class ControllerCommand : CliktCommand() {
    ...
    override fun run() {
        ...
        val providersApi = ProvidersApi(httpServer, ProviderManager(ProvidersRepository(db.dsl)))
